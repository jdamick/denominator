...
public class AAAADataTest {
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Must be an IPV6 Address.*")
    public void testBadIPv4() {
        aaaa("www.denominator.io.", "192.168.254.5");
    }
    
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = ".*is not an IP.*")
